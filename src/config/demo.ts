        ...
        },
        {
          ...
          props: {
            categories: [
              ...
              { id: "peripherals", label: "Peripherals", count: 3 }
            ],
          ...
          props: {
            ...
            data: [
              ...
              },
              {
                ...
                name: "Phone Stand",
                price: 19.99,
                image: "https://images.unsplash.com/photo-1586953229609-7e0c50d40074?w=400",
  ...
  flows: [
    {
      id: "shopping-flow",
      name: "Shopping Flow",
      description: "Main user journey from browsing to purchase",
      steps: ["home", "catalog", "cart", "checkout", "order-success"],
      actions: [
        {
          id: "add-to-cart",
          type: "addToCart",
    ...
    },
    {
      id: "favorites-flow",
      name: "Favorites Flow",
      description: "Browse and manage favorites",
      steps: ["home", "favorites", "cart"],
      actions: [
        {
          id: "add-to-favorites",
          type: "apiCall",
          target: "/api/favorites",
          params: {
            method: "POST"
          }
        },

...
async function main() {
  console.log('Adding booking schema to Directus...\n');
  ...
  await createCollection(api, 'services', 'Services', 'build', [
    ...
    { field: 'duration', type: 'integer', schema: { is_nullable: false, default_value: 30 }, meta: { interface: 'input', options: { suffix: 'minutes' } } },
